...
- 🎯 국비 프로젝트를 통한 웹개발자 실무 역량 확보  
- 🌱 기술 블로그 및 기록 습관으로 꾸준한 성장  
- 🤝 협업과 소통을 중시하는 커뮤니케이션 개발자
...
**기술로 문제를 해결하는 과정에 매력을 느끼고** 사용자 관점에서 문제를 이해하며 해결을 하면서 성장 중인 민예린입니다.
**주어진 일에 집중하여 몰입**하고 **기록과 피드백**을 통해 한 단계씩 발전하는걸 추구합니다.
**피그마를 통해 웹디자인 기획**부터 **다양한 언어 프레임워크로 웹 서비스를 설계 및 구축**을 해본 경험이 있습니다.
사용자 경험을 고려한 **UI/UX설계**, **백앤드 API 서버 구축**, 프론트앤드로 **반응형 웹 구축**, **도커 및 AWS 인프라 배포**로 실전 경험을 쌓았습니다. 
최근에는 **정보보안**의 중요성을 느껴 **시큐어 코딩** 및 **ISMS, 스팸 메일 대응**에 관심을 가지고 있습니다.
**보안과 문제 해결**을 중점으로 같이 성장하며 나아가는 사람이 되고 싶습니다.
...
| 회사명               | 기간                | 주요 역할 및 기술 |
|----------------------|---------------------|-------------------|
| **유인시스** | 2025.08 ~ 2025.12 | 포스코 DX 사내 EP운영, DMARC 리포트 작성 |
...
- GPT, TTS, 이미지 분석 등 AI API 기반 서비스를 실생활 문제 해결에 접목시키는 것에 큰 흥미를 느끼고 있으며, 향후에는 LLM 파인튜닝 및 벡터 DB 기반 RAG 응용도 다뤄보고자 합니다.

- 백엔드뿐 아니라 사용자 경험(UX)을 설계하고 개선하는 프론트엔드 로직에도 꾸준히 관심을 가지고 있으며, 기획자 및 디자이너와의 소통을 통한 제품 중심 개발자로 성장하고자 합니다.
