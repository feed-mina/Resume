...
- 학력:  
  ...
  - 한성대학교 행정학 전공, 경제학 부전공 (2014.03 ~ 2020.02) / GPA 3.36 / 4.5   - 자율주행을 위한 IoT·Bigdata·AI 기술융합 개발자 양성 과정[2022 년 08 월 30 일 ~ 2023 년 03 월 07 일 (960 시간)_엔코아 
...
| 회사명               | 기간                | 주요 역할 및 기술 |
|----------------------|---------------------|-------------------|
| 상록에스 / 유인시스  | 2024.05 ~ 2025.02   | EBS 영어 서비스 운영 및 유지보수, ISMS-P 대응, 백오피스 개발 |
| 솔앤드                | 2023.06 ~ 2024.02   | Spring Security + JWT 기반 카카오 로그인 개발, Vue 관리자 페이지 구축 |
| 무브인터렉티브        | 2023.01 ~ 2023.04   | ASP.NET 웹페이지 유지보수 및 기능 개선, MSSQL DB 구조 분석 및 문서화 |
