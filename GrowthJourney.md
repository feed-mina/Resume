...
| 2020 | 🎥 콘텐츠 마케팅 OJT | 무빙키 AR 스타트업 인턴 → 시장 흐름과 데이터 기반 콘텐츠 기획 |
| 2021 | 🚀 스타트업 PM 경험 | IT 프로젝트 전체 사이클 관리 경험 → 개발/기획/협업 역량 강화 |
| 2021 | 🤖 AI 융합 국비과정 | Java, Python, AI, IoT 등 기초 다지기 → 팀 프로젝트 경험 다수 |
| 2022 | 🎨 미디어 아트 프로젝트 전시 | Azure Face API + 라즈베리 파이 → 기술+예술 융합 프로젝트 직접 기획·개발 |
...
### 1. **도메인 경험의 다양성**
- 콘텐츠 마케팅, 스타트업 PM, 교육봉사 등 다양한 실무를 거치며 **사용자 중심 사고**를 체득
- 기술 + 커뮤니케이션 + 문제 해결 능력을 조화롭게 연결

### 2. **낯선 환경에서의 적응력**
- 미국 어학연수 및 태국 봉사에서의 언어·문화 장벽을 **소통과 진심**으로 극복
- 어떤 환경에서도 **성장 루틴**을 만들어내는 힘 보유 (요가, 달리기 등)

### 3. **지속적인 기록과 정리**
- 콘텐츠 마케팅 시절 카드뉴스 제작 → 개발 블로그로 전환
- 개발 지식 기록, 검색 능력 강화, 실무 피드백 기록을 통해 **꾸준한 성장 로그 유지**
...
### 🧠 문과에서 개발자로
- 행정학 전공 → 데이터 기반 문제 해결에 흥미
- 통계·SAS 실습 등으로 논리적 사고력 배양 → Java/Python 학습으로 전향

### 💬 벽화 봉사 & 문제 해결력
- 예상치 못한 장소 문제 → 사전 이미지 스캔 자료로 골목별 콘셉트 제시
- 주도적으로 팀 분배·설득 → 창의적 방식으로 문제 해결

### 📚 미국 어학연수 & 루틴 구축
- 낯선 환경에서의 슬럼프 → 스스로 인사하고 대화 시도, 요가+달리기 루틴 형성
- 스스로를 회복시키는 힘을 갖게 된 경험
...
또한, 대학 4학년 때 미국 어학연수를 통해 낯선 환경에 적응하며 자신을 성장시킬 수 있었습니다.  
처음에는 문화와 언어의 장벽으로 위축되었지만, 스스로 먼저 다가가고, 요가와 달리기 같은 루틴을 통해 슬럼프를 극복하는 방법도 찾게 되었습니다.

### 4. 기록하는 습관, 성장의 발판이 되다
