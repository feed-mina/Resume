...
### 주식회사 상록에스 / (주)유인시스 (2024.05 ~ 2025.02)
**EBS 영어 웹서비스 운영 및 데이터 분석**

**문제 상황:** 개인정보 관리 체계 미흡 및 트래픽 분석 미흡

**해결 방법:**
- 개인정보 파일 검출 자동화 스크립트 실행 및 고위험 사용자 분류 프로세스 도입
- 주간 클라이언트 트래픽 통계 수집 및 분석 리포트 작성

**성과:**
- 개인정보 검출/분석 프로세스 표준화 및 보고 체계 강화
- 맞춤형 추천 시스템 도입 기획을 위한 API 분석 지원

### 솔앤드 주식회사 (2023.06 ~ 2024.02)
**Vue.js + Spring Boot 기반 웹서비스 구축**

**문제 상황:** 인증 시스템 부재 및 관리자 페이지 관리 효율성 부족

**해결 방법:**
- Spring Security + JWT 기반 카카오 소셜 로그인 기능 설계/구현
- Vue.js 기반 LMS 관리자 페이지 구축 및 데이터 다대다(N:N) 관계 처리

**성과:**
- 인증 체계 강화 및 사용자 접근성 향상
- 관리자 페이지 효율성 증대로 관리 시간 30% 절감

### 무브인터렉티브 (2023.01 ~ 2023.04)
**ASP.NET 기반 웹 구조 분석 및 신규 결제 모듈 기획 지원**

**문제 상황:** 문서화 부재 및 결제 시스템 수수료 부담

**해결 방법:**
- 기존 C#/ASP.NET 프로젝트를 Doxygen으로 문서화 및 구조 정리
- 신규 결제 API 분석 및 비용 최적화 제안

**성과:**
- 개발 문서 체계화 및 후속 개발 인수인계 효율화
- 신규 결제 모듈 도입 기획 지원으로 연간 운영비 20% 절감 기여
